...
public class JianFanConvert2 {
	 ...
	 * 繁体简体映射表
	 */
	public static Map<String, String> fan2jian = new HashMap<String, String>();
	/**
	 * 简体繁体映射表
	 */
	public static Map<String, String> jian2fan = new HashMap<String, String>();

	private static JianFanConvert2 instance = new JianFanConvert2();

	private JianFanConvert2() {

	}

	public static JianFanConvert2 getInstance(int converterType)
...
//			System.out.println("错误");
	...
	public static void main(String[] args) throws IOException {
		...
		*/
		JianFanConvert2 jfc = getInstance(TRADITIONAL);
//		System.out.println("jian2fan:" + jian2fan.size());
//		System.out.println("fan2jian:" + fan2jian.size());
		/**
		 * 为了测试随着问题规模的扩大用时
		 */
		// for(int i=0;i<10;i++){
		...
		String jian = jfc.jian2fan("有背光的機械式鍵盤");
		System.out.println(jian);
		long end = System.currentTimeMillis();
//		System.out.println("\n用时：" + (end - begin));
	}

	public String jian2fan(String fan) throws IOException {
		StringBuffer sb = new StringBuffer();
		String[] split = fan.split("");
		for (int i = 1; i < split.length; i++) {
			String key = split[i];
			if (jian2fan.containsKey(key)) {
				sb.append(jian2fan.get(key));
			} else {
				sb.append(key);
			}
		}
	...
	public String fan2jian(String jian) throws IOException {
		StringBuffer sb = new StringBuffer();
		String[] split = jian.split("");
		for (int i = 0; i < split.length; i++) {
			String key = split[i];
			if (fan2jian.containsKey(key)) {
				sb.append(fan2jian.get(key));
			} else {
				sb.append(key);
			}
		}
	...
	private void init() throws FileNotFoundException, IOException {
		Class<? extends JianFanConvert2> jfcc = this.getClass();
//		URL u = jfcc.getResource("/jf.txt");
//		System.out.println(u.getFile());
		InputStream resourceAsStream = jfcc.getResourceAsStream("/jf.txt");
...
//					System.out.println(temp + " 错误 " + a);
			...
			for (int i = 0; i < split.length; i++) {
				...
				String jian = split2[0];
				String fan = split2[1];
				jian2fan.put(jian, fan);
				fan2jian.put(fan, jian);
			}
		}
//		System.out.println("读取行数计数：" + a);
	}
}